...
* Change Managment: Ordering the render sequence.
* Nesting Management: Handling the parent-child relationships.
* Options Managment: Serialization of nested configuration options.
* Drag Management: Drag & Drop as a core built-in service.

### Nesting and Geometry
...
* Root: This layout extends positioner, and is designed to be the root tile of the document.  This is essentially the bootstrap tile of the dash, and should
...
* Resizer: This layout will stack its children either horizontally or vertically, depending on the axis option, and will allow the children to be resized
...
* Slider: This is how you create sliding marquees, and replicates the functionality of the old dash.  This hasn't been fleshed out yet though, so it won't
work yet.

* Stacker: This is how you create widgets.  You give it either a vertical or horizontal stacking axis and give one of the child tiles the property of name='body'.
...
* Spacer: This works almost identically to resizer, but no edges are inserted between tiles, and there is no resizing.  All the children are equal in size.
...
* Measuring after each update degrades performance by 10x.
* Using raw DOM operations over jquery append improves performance 4x.
* Using one .html() over .append improves performance 3x.
